...
export default function MediaCard({ item, title, section = false }: { item: MediaItem, title?: string, section?: boolean }) {
  ...
  return (
    <div dir="rtl" onClick={() => router.push(`/details/${item.type == "فيلم" ? "movie" : "tv"}/${item.id}`)}
