      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={searchContainerRef}>
            <div className={`transition-all duration-300 overflow-hidden ${showInput ? "opacity-100 md:w-50 lg:w-80 xl:w-120" : "opacity-0 w-0"}`}>
              <input
                ref={inputRef}
                type="text"
      ...
      <header className="md:hidden fixed w-full px-2 h-13 bg-gradient-to-b from-black/80 to-transparent rounded-b-xl flex items-center justify-between z-50">
        ...
        <div className="flex gap-2 items-center w-full">
          <div className="relative w-full mr-2" ref={searchContainerRef}>
            <div className={` transition-all duration-300 transform rounded-full backdrop-blur-md origin-left overflow-hidden ${showInput ? "scale-x-100 opacity-100" : "scale-x-0 opacity-0"}`}>
              <input
                ref={inputRef}
                type="text"
                placeholder="بتدور على ايه..."
